...
int main(int argc, const char * argv[]) {
	...
	//cout << point2Interval(new EcldPoint(), <#EcldPoint *#>, <#EcldPoint *#>)
	...
	PreProcessor::getInstance()->generateRoadNetTrajectory(
		g, "/Users/songrenchu/Develop/test/input/", "/Users/songrenchu/Develop/test/output/",
		new FileWriter("/Users/songrenchu/Develop/test/spatial.txt", true),
		new FileWriter("/Users/songrenchu/Develop/test/temporal", true)
	);
