...
* Node that our program is focused on contest, so we didn't take robust into consideration. Our program can only process no more than 10000 points within 1 trajectory. So please partition the trajectory into parts if it is longer. 